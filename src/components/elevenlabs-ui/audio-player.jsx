...
var NetworkState = (function (NetworkState) {
...
export const AudioPlayerProgress = ({ ...otherProps }) => {
...
const PlayButton = ({ playing, onPlayingChange, className, onClick, loading, ...otherProps }) => {
  return (
    <Button
      {...otherProps}
      onClick={(e) => {
...
export function AudioPlayerSpeedButtonGroup({ speeds = [0.5, 1, 1.5, 2], className, ...props }) {
  const player = useAudioPlayer();
  const currentSpeed = player.playbackRate;
