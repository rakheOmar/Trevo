        ...
        <div className="mt-8 grid w-full max-w-4xl @2xl:grid-cols-3 gap-4">
          {plans.map((plan) => (
            ...
            >
                ...
                <CardDescription>
                  ...
                  {typeof plan.price[frequency] === "number" ? (
                    <span className="font-medium text-foreground">
                      ${plan.price[frequency]} /month, billed {frequency}.
                    </span>
                  ) : (
                    <span className="font-medium text-foreground">{plan.price[frequency]}.</span>
                  )}
                </CardDescription>
              </CardHeader>
              ...
              <CardFooter>
                <Button className={`w-full ${navButtonClass}`} variant="default">
                  {plan.cta}
