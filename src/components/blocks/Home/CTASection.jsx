...
const FinalCTA = () => {
  return (
    <section className="mx-auto w-[80%] px-4 pb-24 sm:px-6 lg:px-8">
      <div className="group relative h-[360px] w-full overflow-hidden bg-card">
        ...
        <div className="relative z-10 flex h-full max-w-2xl flex-col justify-end items-start p-8 text-left md:p-12">
